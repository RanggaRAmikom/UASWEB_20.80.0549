...
--
-- Host: localhost:3306
-- Waktu pembuatan: 27 Jan 2022 pada 02.34
-- Versi server: 5.7.33
-- Versi PHP: 7.4.19
...
--
-- Struktur dari tabel `tbl_students_0549`
--

CREATE TABLE `tbl_students_0549` (
  `id` int(255) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_students_0549`
--

INSERT INTO `tbl_students_0549` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indeks untuk tabel `tbl_students_0549`
--
ALTER TABLE `tbl_students_0549`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `tbl_students_0549`
--
ALTER TABLE `tbl_students_0549`
